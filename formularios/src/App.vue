  ...
  <div id="app">
    ...
    <div class="conteudo">
      <form class="painel" v-if="!enviado">
        ...
        <Rotulo nome="E-mail">
          <!-- lazy valida só quando sai do campo -->
          <!-- trim remove os espaços -->
          <!-- number coloca pra instância do vue um número não uma string -->
        ...
        <Rotulo nome="Características do Problema">
          <span class="mr-4">
            <input v-model="caracteristicas" type="checkbox" value="reproduzivel" /> Reproduzível
          </span>
          <span>
            <input v-model="caracteristicas" type="checkbox" value="intermitente" /> Intermitente
          </span>
        </Rotulo>
